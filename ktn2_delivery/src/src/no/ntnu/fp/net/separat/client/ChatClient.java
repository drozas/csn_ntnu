...
import no.ntnu.fp.net.separat.server.ChatServer;
...
public class ChatClient {
    ...
    public ChatClient(String address, int port, int myport) {
        this.thisPort = myport;
    ...
    public static void main(String[] args) {
        ...
        ChatClient client = new ChatClient(address,port,myport);
    }
